        ...
        configuration.setWindowListener(new Lwjgl3WindowAdapter() {
            ...
            public void filesDropped(String[] files) {
                for (String file : files) {
                    ...
                    if(Main.getMain().getScreen() instanceof ProfileMenuView){
                        ProfileMenuView profileMenuView = (ProfileMenuView) Main.getMain().getScreen();
                        Gdx.app.postRunnable( () -> profileMenuView.processDragDrop(file));
                    }
//                    if (file.endsWith(".png")) {
//                        com.badlogic.gdx.Gdx.app.postRunnable(() -> {
//                            if (App.isInProfileMenu()) {
//                                App.getCurrentPlayer().setAvatarPath(file); // Absolute path
//                            }});
//                    }
                }
            }
