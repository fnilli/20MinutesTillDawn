...
public class EyeMonster {
    ...
    //shoot arrow
    private float shootCooldown = 3f;  // seconds between shots
    private float timeSinceLastShot = 0f;



    public EyeMonster(float x, float y, Animation<Texture> animation) {
        this.x = x;
        this.y = y;
    ...
    public void update(float deltaTime) {
        ...
        timeSinceLastShot += deltaTime; // track time for shooting
    }
