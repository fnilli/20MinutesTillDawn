...
public enum Heros {
    Shana(4, 4, "Images/Sprite/Idle/Idle_0.png", "Images/Sprite/T/T_Shana_Portrait.png",
        GameAssetManager.getGameAssetManager().getShanaAnimation()),
    Diamond(2, 7, "Images/Sprite/Idle/Idle_1.png", "Images/Sprite/T/T_Diamond_Portrait.png",
        GameAssetManager.getGameAssetManager().getDiamondAnimation()),
    Scarlet(5,3, "Images/Sprite/Idle/Idle_2.png", "Images/Sprite/T/T_Scarlett_Portrait.png",
        GameAssetManager.getGameAssetManager().getScarletAnimation()),
    Lilith(3, 5, "Images/Sprite/Idle/Idle_3.png", "Images/Sprite/T/T_Lilith_Portrait.png",
        GameAssetManager.getGameAssetManager().getLilithAnimation()),
    Dasher(10,2, "Images/Sprite/Idle/Idle_4.png", "Images/Sprite/T/T_Dasher_Portrait.png",
